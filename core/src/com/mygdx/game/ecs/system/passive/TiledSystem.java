...
import com.mygdx.game.util.OrthogonalTiledMapRendererStopStartAnimated;
...
public class TiledSystem extends EntitySystem {
    ...
    private void init() {
        ...
        collideTileLayer = (TiledMapTileLayer) tiledMap.getLayers().get("l_coins");
    ...
    public boolean collideWith(Rectangle rectangle) {
        ...
        tmpArea.set(rectangle.x - tileWidth, rectangle.y - tileHeight,
                rectangle.width + tileWidth , rectangle.height + tileHeight );
